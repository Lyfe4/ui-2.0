...
export function ContentPane({ canvasOpen, onToggleCanvas }: ContentPaneProps) {
  return (
    <div className="flex min-w-0 flex-1 flex-col overflow-hidden rounded-xl bg-stone-50">
      <div className="flex items-center justify-between px-8 py-4">
        <h1 className="text-base font-semibold text-primary">Budgeting</h1>

        <div className="flex items-center gap-5">
          <div className="flex items-center gap-2 text-sm">
            <span className={cn("transition-colors", !canvasOpen ? "font-medium text-stone-800" : "text-stone-400")}>
              Content
            </span>
            <button
          ...
          <span className="text-sm text-stone-400">
            Objectives: <span className="font-medium text-stone-700">0/1</span>
          </span>

          <div className="flex items-center gap-1.5">
            <div className="h-7 w-7 rounded-full bg-stone-300" />
            <div className="h-7 w-7 rounded-full bg-stone-700" />
          </div>

          <div className="rounded bg-stone-800 px-2 py-0.5">
            <span className="text-xs font-bold tracking-tight text-stone-100">une</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-8 py-7">
        <div className="mb-8 flex items-center gap-2.5 text-xs text-stone-400">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="h-2.5 w-2.5 rounded-full border-2 border-stone-300 bg-stone-50" />
          </div>
          <span>Lessons 1–2</span>
          <span>·</span>
          <span className="font-medium text-stone-600">Lesson 1: Introduction</span>
